...
CREATE TABLE "settings" (
	...
	"tolerances" jsonb DEFAULT '{"enToleranceMm":10,"boyToleranceMm":10}'::jsonb NOT NULL,
	"default_colors" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"qr_type" varchar(20) DEFAULT 'QR' NOT NULL,
	"cost_settings" jsonb,
	"shift_settings" jsonb,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "settings_factory_id_unique" UNIQUE("factory_id")
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "factories" ADD CONSTRAINT "factories_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
